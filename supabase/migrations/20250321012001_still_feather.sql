/*
  # Fix decimal handling in width_size array
  
  1. Changes
    - Drop and recreate curtain_fabrics table with proper numeric array type
    - Add proper constraints and defaults
    - Ensure decimal values like 11.8 can be stored correctly
*/
