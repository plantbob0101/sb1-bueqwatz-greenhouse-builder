/*
  # Fix NS30 field in rollup_walls table

  1. Changes
    - Drop and recreate table with proper field definitions
    - Add proper constraints and defaults
    - Ensure NS30 field is properly defined
*/
...
CREATE TABLE rollup_walls (
  ...
  ns30 text NOT NULL CHECK (ns30 IN ('Yes', 'No')) DEFAULT 'No',  -- Changed from NS30 to ns30
  ...
  motor_model text,
  gearbox_pocket integer DEFAULT 0,
  simu_winch integer DEFAULT 0,
  ridder_mount_guttered integer DEFAULT 0,
  ridder_mount_quonset integer DEFAULT 0,
  notes text,
