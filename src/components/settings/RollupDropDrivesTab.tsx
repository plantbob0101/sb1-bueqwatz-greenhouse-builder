...
export default function RollupDropDrivesTab() {
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Failed to delete roll-up/drop drive');
    } finally {
      ...
      {showDeleteConfirm && (
        <div className="fixed top-0 left-0 right-0 bottom-0 bg-black bg-opacity-50 flex items-center justify-center" style={{ zIndex: 9999 }}>
          <div className="relative bg-white p-6 rounded-lg shadow-xl max-w-md w-full mx-4">
            ...
            <p className="mb-6 text-gray-700">Are you sure you want to delete this roll-up/drop drive?</p>
